...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#d8f3dc", background: "#081c15", backgroundDisabled: "#E9EAEB", contrast: "#d8f3dc", invertedContrast: "#191326", input: "#eeeaf4", primaryDark: "#F2DA91", tertiary: "#f7e9dc", text: "#52b788", textDisabled: "#BDC2C4", textSubtle: "#221922", borderColor: "#524B63", card: "#1b4332", gradients: {
