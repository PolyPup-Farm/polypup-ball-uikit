...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#fbfff7", backgroundDisabled: "#dde6da", contrast: "#d8f3dc", invertedContrast: "#f1faee", input: "#80ed99", tertiary: "#EFF4F5", text: "#2d6a4f", textDisabled: "#a4a9ab", textSubtle: "#1b4332", borderColor: "#57cc99", card: "#d8f3dc", gradients: {
